...
Para la realización de la prueba he tenido en cuenta los siguientes factores:
  ...
  - Inicializar aleatoriamente el número de celulas que estan vivas o muertas.
  ...
  - La forma de mostrar el grid, en este caso mediante canvas.
      ...
      Para difenciar entre vivas y muertas, coloreamos las células vivas (valor 1) con un color diferente al resto mediante fillStyle.
      Mediante el metodo fillRect() dibujamos la celdas del grid.
